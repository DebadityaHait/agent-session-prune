...
export type Audit = { schemaVersion: 1; generatedAt: string; roots: string[]; items: Item[]; bytes: number; candidates: number; protectedBytes: number };
...
export type Manifest = { schemaVersion: 1; archiveId: string; createdAt: string; entries: ManifestEntry[] };
